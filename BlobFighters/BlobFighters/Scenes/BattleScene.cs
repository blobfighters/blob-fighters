...
namespace BlobFighters.Scenes
{
    public class BattleScene : Scene
    {
        ...
        protected override void OnInit()
        {
            ...
            healthP1 = new PercentageIndicator(font, new Vector2(GameManager.Width - 1060, GameManager.Height - 125),blob1);
            healthP2 = new PercentageIndicator(font, new Vector2(GameManager.Width - 400, GameManager.Height - 125),blob2);
            ground = new Ground();

            Camera.Position += new Vector2(0f, -GameManager.Instance.GraphicsDevice.Viewport.Height * 0.5f);
            Camera.Scale = new Vector2(0.5f);

            materialsPosition1 = new Vector2(GameManager.Width - 1125, GameManager.Height - 30);
            new MaterialBrowser(materialsPosition1, blob1.PlayerId);
            materialsPosition2 = new Vector2(GameManager.Width - 600, GameManager.Height - 250);
